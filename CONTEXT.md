...
**Enemy Kind**:
Enemy 的類型,決定 Health 與移動速度的傾向。目前有四種:

- **Grunt**:中 Health、中速度
- **Runner**:低 Health、高速度
- **Tank**:高 Health、低速度
- **Boss**:極高 Health、低速度(與 Tank 同速),每 5 個 Wave 額外出現一次(見下方 Wave),目前無獨立機制,純粹是數值更高的變體
